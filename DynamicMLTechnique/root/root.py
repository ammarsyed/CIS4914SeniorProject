...
def train(model):
    ...
    dataset_train.load_root(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = RootDataset()
    dataset_val.load_root(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect roots.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/root/dataset/",
                        help='Directory of the Root dataset')
